...
public class Campfire : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (stats != null)
        {
            ...
            if (isLit)
            {
                ...
                // Начинаем треск огня когда игрок подошёл
                AudioManager.Instance?.StartFireLoop();
            }
        }
    }

    // Когда игрок выходит из зоны тепла
    private void OnTriggerExit(Collider other)
    {
        ...
        if (stats != null && stats == playerStatsInZone)
        {
            ...
            // Останавливаем треск когда игрок отошёл
    ...
    public bool AddFuel(ItemData item)
    {
        ...
        // Звук подброса дров
        AudioManager.Instance?.PlayAddFuel();
