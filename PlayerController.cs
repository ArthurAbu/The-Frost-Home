...
public class PlayerController : MonoBehaviour
{
    ...
    private void CheckGrounded()
    {
        ...
        // Бросаем сферу вниз от нижней точки капсулы. Если она касается земли то персонаж стоит на земле.
    ...
    private void HandleMovement()
    {
        ...
        // Звуки шагов только когда движемся
        if (isMoving)
            AudioManager.Instance?.TryPlayFootstep(isRunning);
        else
            AudioManager.Instance?.ResetFootstepTimer();
